jQuery(function($){$('body.no-js').removeClass('no-js');if(typeof $.fn.fitVids!=='undefined'){$('.entry-content, .entry-content .panel').fitVids();}
if(!$('body').hasClass('so-lp-mobile-device')||$('nav.site-navigation.primary').hasClass('mobile-navigation')){$(window).scroll(function(){if($(window).scrollTop()>150){$('#scroll-to-top').addClass('displayed');}
